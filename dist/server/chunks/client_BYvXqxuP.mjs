...
import pg from "pg";
import { bigint, bigserial, boolean, jsonb, pgTable, text, timestamp, uniqueIndex, varchar } from "drizzle-orm/pg-core";
...
var posts = pgTable("posts", {
	...
	aiSummary: jsonb("ai_summary").$type().notNull(),
...
var inboundWebhooks = pgTable("inbound_webhooks", {
	id: bigserial("id", { mode: "number" }).primaryKey(),
...
var db = drizzle(new pg.Pool({ connectionString: process.env.DATABASE_URL }), { schema: schema_exports });
//#endregion
export { posts as n, db as t };
